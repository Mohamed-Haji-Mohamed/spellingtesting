class SpellingQuiz {
  constructor() {
    this.questions = [
      { question: "Choose the correct spelling", options: ["Iducation", "Education", "Educasion", "Iducasion"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Atention", "Attention", "Attension", "Atension"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Comunity", "Community", "Comunitie", "Communety"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Prasident", "President", "Presidant", "bresident"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Secratary", "Secretary", "Sacretary", "Sacratary"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Celepration", "Celebration", "Calebration", "Celabration"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Oparation", "Operation", "Operasion", "Oberation"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Agreament", "Agreement", "Agreemant", "Agreamant"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Equipmant", "Equipment", "Equibment", "Equibmant"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Polution", "Pollution", "bollution", "Pollusion"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Permision", "Permission", "Parmission", "Permession"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Quession", "Question", "Quesion", "Quastion"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Peragraph", "Paragraph", "baragraph", "Paragreph"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Experiance", "Experience", "Experiense", "Exbrience"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Farniture", "Furniture", "Furneture", "Farneture"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Actevities", "Activities", "Activites", "Actevites"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Excelent", "Excellent", "Excellant", "Excallent"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Necesary", "Necessary", "Necessery", "Nacessary"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Risources", "Resources", "Resourcies", "Recourses"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Knawledge", "Knowledge", "Knowladge", "Knawladge"], answer: 1 }
    ];
