class SpellingQuiz {
  constructor() {
    this.questions = [
      { question: "Choose the correct spelling", options: ["Hows", "House", "Huose", "Hous"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Hourse", "Horse", "Horsey", "Hoursey"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Kitchan", "Kitchen", "Kichen", "Kitchane"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Towal", "Towel", "Towwal", "Towale"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Appel", "Apple", "Appal", "Abble"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Freezar", "Freezer", "Freezor", "Freezerr"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Pencal", "Pencil", "bencil", "bencal"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Peper", "Paper", "Pepar", "peaper"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Carpat", "Carpet", "Carbet", "Carbat"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Cheir", "Chair", "Chare", "Cheire"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Botle", "Bottle", "Botal", "potle"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Famely", "Family", "Femily", "Familey"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Mathar", "Mother", "Mather", "Mathare"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Fathar", "Father", "Fathare", "Fethar"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Freind", "Friend", "Frend", "Friend"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Dinnar", "Dinner", "Diner", "Dinar"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Launch", "Lunch", "Lunche", "Lanch"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Streat", "Street", "Striet", "Estreet"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Animall", "Animal", "Animale", "Anemal"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Markat", "Market", "Markate", "Markat"], answer: 1 }
    ];
