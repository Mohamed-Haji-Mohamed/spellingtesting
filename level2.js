class SpellingQuiz {
  constructor() {
    this.questions = [
      { question: "Choose the correct spelling", options: ["Toylet", "Toilet", "Toilat", "Toilate"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Miror", "Mirror", "Merror", "Mirrore"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Jackat", "Jacket", "Jakate", "Jackete"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Ofice", "Office", "Offic", "Officie"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Fingar", "Finger", "Fenger", "Fingar"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Bredge", "Bridge", "Briche", "Brieche"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Tiket", "Ticket", "Tecket", "Tickate"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Pasport", "Passport", "Passbort", "bassport"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Circole", "Circle", "Cercle", "Cercole"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Drever", "Driver", "Driever", "Draver"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Doctar", "Doctor", "Dactor", "Dectar"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Narse", "Nurse", "Naurse", "Nerse"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Teachar", "Teacher", "Tiecher", "Teicher"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Studant", "Student", "Estudent", "Studint"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Frige", "Fridge", "Fredge", "Friedge"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Grownd", "Ground", "Garound", "Geround"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Honeste", "Honest", "Onest", "Honaste"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Yelow", "Yellow", "Yellaw", "Yellowe"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Falight", "Flight", "Felight", "Flieght"], answer: 1 },
      { question: "Choose the correct spelling", options: ["Iland", "Island", "Iseland", "Isieland"], answer: 1 }
    ];
